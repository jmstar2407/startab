(() => {
  ...
  const supportsPointerAgent = (version) => versionAtLeast(version, 1, 6, 0);
  const supportsScrollAgent = (version) => versionAtLeast(version, 1, 6, 0);
  const supportsAdvancedAgent = (version) => versionAtLeast(version, 1, 6, 0);
